...
Why the source is NOAA OISST and not Copernicus
-----------------------------------------------
Measured against `services/download/catalog.py` rather than assumed: every
Copernicus provider in this codebase starts recently — physics 2022-06-01, waves
2022-11-01, wind 2024-06-13, BGC 2021-11-01. A 30-year baseline is not expensive
on that path, it is **impossible**. NOAA OISST v2.1 is daily 0.25 degree SST from
1981-09-01 to the present, served by the same CoastWatch ERDDAP `services/crw.py`
already uses, and one year of it strided to 1 degree is ~95 MB in a single
griddap request.
