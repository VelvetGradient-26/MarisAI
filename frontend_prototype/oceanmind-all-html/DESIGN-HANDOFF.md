# 0427765a-a25a-49bd-8abe-8d6fade33157 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `dashboard-3d-map.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `dashboard-3d-map.html`
...
- A single self-contained `dashboard-3d-map.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `dashboard-3d-map.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `dashboard-3d-map.html`
- `dashboard-biodiversity.html`
- `dashboard-fisheries.html`
- `dashboard-oceanographic.html`
- `login.html`
- `oceanmind-all-dashboards.html`
...
- `flow-1.jpeg`
- `flow.jpeg`
- `oceanmind-ai-dashboards.zip`
- `oceanmind-all-dashboards.zip`
- `WhatsApp-Image-2026-07-23-at-2.51.22-PM.jpeg`
- `WhatsApp-Video-2026-07-23-at-2.51.27-PM.mp4`

## Coding checklist for AI tools
1. Inspect `dashboard-3d-map.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
